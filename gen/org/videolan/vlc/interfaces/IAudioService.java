 ...
 * Original file: /Users/techflag/Documents/workspace/masgbDemo/src/org/videolan/vlc/interfaces/IAudioService.aidl
 */
...
case TRANSACTION_removeLocation:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.removeLocation(_arg0);
reply.writeNoException();
return true;
}
...
@Override public void removeLocation(java.lang.String location) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_removeLocation, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_removeLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getMediaLocations = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getCurrentMediaLocation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isPlaying = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isShuffling = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getRepeatType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_setRepeatType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_hasMedia = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_hasNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_hasPrevious = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getTitle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getTitlePrev = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getTitleNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getArtist = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getArtistPrev = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getArtistNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getAlbum = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getTime = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getLength = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getCover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getCoverPrev = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getCoverNext = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_addAudioCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_removeAudioCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_detectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_showWithoutParse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_playIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_getRate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
}
...
public void removeLocation(java.lang.String location) throws android.os.RemoteException;
