...
import com.broov.player.masgb.ui.MainActivity;
    ...
    private void showNotification() {
        try {
            ...
            if (LibVlcUtil.isJellyBeanOrLater()) {
                ...
                RemoteViews view = new RemoteViews(getPackageName(), R.layout.vlcnotification);
                if (cover != null)
                    view.setImageViewBitmap(R.id.cover, cover);
                view.setTextViewText(R.id.songName, title);
                view.setTextViewText(R.id.artist, artist);
                //view.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable. : R.drawable.ic_play_w);
