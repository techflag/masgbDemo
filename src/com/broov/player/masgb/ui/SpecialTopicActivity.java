...
public class SpecialTopicActivity extends TabActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent1 = new Intent(SpecialTopicActivity.this,
				SpecialTopicingActivity.class);
		intent2 = new Intent(SpecialTopicActivity.this,
				SpecialTopicedActivity.class);
		intent3 = new Intent(SpecialTopicActivity.this,
				ForTheTopicActivity.class);

		LayoutInflater inflater = LayoutInflater
				.from(SpecialTopicActivity.this);
		View view1 = inflater.inflate(R.layout.tabitem_8, null);
		View view2 = inflater.inflate(R.layout.tabitem_9, null);
		View view3 = inflater.inflate(R.layout.tabitem_10, null);
	...
	private void initHolder() {
		...
		tvTitle = (TextView) findViewById(R.id.tvTitle_topic);
		imgTitleBack = (ImageView) findViewById(R.id.imgTitleBack_topic);
		tvName = (TextView) findViewById(R.id.tvName_topic);
		initLayoutParams();
	}
	...
	private void initLayoutParams() {
		...
		imgTitleBackParams.setMargins(
				(int) (10 * SpecialTopicActivity.widthScale),
				(int) (13 * SpecialTopicActivity.heightScale), 0, 0);
		imgTitleBack.setLayoutParams(imgTitleBackParams);

		RelativeLayout.LayoutParams tvTitleParams = new RelativeLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		tvTitleParams.setMargins((int) (30 * SpecialTopicActivity.widthScale),
				(int) (2 * SpecialTopicActivity.heightScale), 0, 0);
		tvTitle.setLayoutParams(tvTitleParams);

		RelativeLayout.LayoutParams tvNameParams = new RelativeLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		tvNameParams.setMargins((int) (238 * SpecialTopicActivity.widthScale),
				(int) (2 * SpecialTopicActivity.heightScale), 0,
				(int) (10 * SpecialTopicActivity.heightScale));
