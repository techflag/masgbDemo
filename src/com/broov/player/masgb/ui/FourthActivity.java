...
public class FourthActivity extends TabActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		intent1 = new Intent(FourthActivity.this, BBSListActivity.class);

		LayoutInflater inflater = LayoutInflater.from(FourthActivity.this);
		View view1 = inflater.inflate(R.layout.tabitem_11, null);
	...
	private void initHolder() {
		...
		slideMenu = (SlideMenu) findViewById(R.id.slide_menu4);
		tvTitle = (TextView) findViewById(R.id.tvTitle4);
		imgTitleBack = (ImageView) findViewById(R.id.imgTitleBack4);
	...
	private void initLayoutParams() {
		...
		imgTitleBackParams.setMargins((int) (10 * FourthActivity.widthScale),
				(int) (13 * FourthActivity.heightScale), 0, 0);
		imgTitleBack.setLayoutParams(imgTitleBackParams);

		RelativeLayout.LayoutParams tvTitleParams = new RelativeLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		tvTitleParams.setMargins((int) (30 * FourthActivity.widthScale),
				(int) (2 * FourthActivity.heightScale), 0, 0);
		tvTitle.setLayoutParams(tvTitleParams);

		RelativeLayout.LayoutParams tvNameParams = new RelativeLayout.LayoutParams(
				LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
		tvNameParams.setMargins((int) (238 * FourthActivity.widthScale),
				(int) (2 * FourthActivity.heightScale), 0,
				(int) (10 * FourthActivity.heightScale));
